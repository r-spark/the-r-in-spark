...
Since `sparklyr` has been deployed in various Cloudera deployments, `sparklyr` got certified with Cloudera[@cloudera-sparklyr-certification], this means that, Cloudera's support is aware of `sparklyr` and can be more effective helpingorganizations using Spark and R.
