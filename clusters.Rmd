...
```{r clusters-trends, echo=FALSE, message=FALSE, fig.align = 'center', out.width='100%', fig.cap='Google trends for on-premise (mainframe), cloud computing and kubernetes.'}
library(dplyr)
library(r2d3)
...
```{r clusters-spark-standalone, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Spark Standalone Site.'}
...
```{r clusters-spark-standalone-web-ui, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Spark Standalone Web Interface.'}
...
```{r clusters-spark-standalone-shot, echo=FALSE, eval=FALSE}
invisible(webshot::webshot(
  "http://localhost:8081/",
...
```
```{r clusters-spark-standalone-web-ui-worker, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Spark Standalone Worker Web Interface.'}
...
```{r clusters-mesos-spark, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Mesos Landing Site.'}
...
```{r clusters-kubernetes-spark, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Kubernetes Landing Site.'}
...
```{r clusters-cloudera-spark, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Cloudera Landing Site.'}
...
```{r clusters-hortonworks-spark, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Hortonworks Landing Site.'}
...
```{r clusters-mapr-spark, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='MapR Landing Site.'}
...
```{r clusters-amazon-emr, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Amazon EMR Landing Site.'}
...
![Launching an Amazon EMR Cluster.](images/clusters-amazon-emr-launching.png)
...
```{r clusters-databricks, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Databricks Landing Site.'}
...
![Databricks community notebook running sparklyr.](images/clusters-databricks-sparklyr.png)
...
```{r clusters-google-dataproc, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Google Dataproc Landing Site.'}
knitr::include_graphics("images/clusters-dataproc.png")
```
![Google Dataproc Landing Site.](images/clusters-dataproc.png)

A cluster can be easily created from the Google Cloud console or the Google Cloud command line interface:

![Launching a Dataproc cluster.](images/clusters-dataproc-launching.png)
...
```{r clusters-ibm, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='IBM Landing Site.'}
...
![IBM Watson Studio using RStudio and sparklyr](images/clusters-ibm-sparklyr.png)
...
```{r clusters-azure-hdinsight, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Azure HDInsight Landing Site.'}
...
![Creating an Azure HDInsight Spark Cluster](images/clusters-azure-mlservices.png)
...
```{r clusters-rstudio-server, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='RStudio Server.'}
...
```{r clusters-jupyter-project, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Project Jupyter.'}
...
```{r clusters-apache-livy, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Apache Livy Landing Site.'}
