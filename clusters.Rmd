...
For **on-premise**, your organization purchased physical computers intended for cluster computing. The computers could be made of _off-the-shelf_ or _high-performance_ hardware. Off-the-shelf means computers usually found in stores shelves.  High-performance means that the vendor provided highly customized computing hardware. The hardware comes optimized for high-performance network connectivity, power consumption, etc. 
...
As mentioned in the Overview section, on-premise clusters are computing instances procured and managed by your organization. These clusters can be highly customized and controlled. The trade off is that they incur higher initial expenses and maintenance costs. 
