...
render_image("images/clusters-yarn-resource-manager.png", "YARN's Resource Manager running sparklyr application")
```

Since YARN is the cluster manager from the Hadoop project, the main documentation can be found under the [hadoop.apache.org](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/YARN.html), you can also reference the "Running Spark on YARN" guide from [spark.apache.org](https://spark.apache.org/docs/latest/running-on-yarn.html).
...
render_image("images/clusters-mesos-webui.png", "Mesos web interface running Spark from R")
```
...
Cloudera provides the Cloudera Manager web interface to manage resource, services, parcels, diagnostics, etc. Figure \@ref(fig:lusters-cloudera-manager-spark) shows a Spark parcel running in Cloduera Manager which you can later use to connect from R.
...
render_image("images/clusters-cloudera-manager.png", "Cloudera Manager running Spark parcel")
```
