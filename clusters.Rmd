...
[Qubole](https://www.qubole.com) is a company founded in 2013 with a mission to close the data accessibility gap. Qubole delivers a Self-Service Platform for Big Data Analytics built on Amazon, Microsoft, Google and Oracle Clouds. In Qubole, you can launch Spark clusters which you can then use from [Qubole notebooks](https://docs.qubole.com/en/latest/user-guide/notebooks-and-dashboards/notebooks/notebook.html) or RStudio Server. Figure \@ref(fig:clusters-qubole-notebook) shows a Qubole notebook using Spark through `sparkylr`.
