...
You can then navigate to the "Master Public DNS" under port 8787, for instance: http://ec2-12-34-567-890.us-west-1.compute.amazonaws.com:8787, and login with user `hadoop` and password `<password>`.
...
| Instance   | CPUs | Memory | Storage | EC2 Price     | EMR Price     |
|------------|------|--------|---------|---------------|---------------|
