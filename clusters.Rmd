...
Mesos is also an Apache project with its documentaiton available under [https://mesos.apache.org/](https://mesos.apache.org/), the "Running Spark on Mesos" guide from [spark.apache.org](https://spark.apache.org/docs/latest/running-on-mesos.html) is a great resource if you choose to use Mesos as your cluster manager.
