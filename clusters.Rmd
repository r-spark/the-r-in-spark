...
Using the [Amazon Command Line Interface](https://aws.amazon.com/cli/), you can launch a cluster with 3 nodes as follows:
...
To launch a cluster using the web interface, reffer to ["Running sparklyr from the AWS Big Data Blog"](https://aws.amazon.com/blogs/big-data/running-sparklyr-rstudios-r-interface-to-spark-on-amazon-emr/)[@amazon-emr-sparklyr-blog]. 
...
Regarding cost, the most up to date information can be found under [aws.amazon.com/emr/pricing](https://aws.amazon.com/emr/pricing/). As of this writting, these are some of the instance types available in the `us-west-1` region:

| Instance   | CPUs | Memory | Storage | EC2 Price | EMR Price | Total         |
|------------|------|--------|---------|-----------|-----------|---------------|
| c1.medium  | 2    | 2GB    | 350GB   | $0.148/hr | $0.030/hr | $0.178 USD/hr |
| m3.2xlarge | 8    | 30GB   | 160GB   | $0.616/hr | $0.140/hr | $0.756 USD/hr |
| i2.8xlarge | 32   | 244GB  | 6400GB  | $7.502/hr | $0.270/hr | $7.772 USD/hr |
