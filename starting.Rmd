...
```{r starting-r-download, echo=FALSE, fig.width=4, fig.align='center', fig.cap='The R Project for Statistical Computing.'}
...
```{r starting-java-download, fig.width=4, fig.align='center', echo=FALSE, fig.cap='Java Download.'}
...
```{r starting-rstudio-download, fig.width=4, fig.align='center', echo=FALSE, fig.cap='RStudio Downloads.'}
...
```{r starting-install-github, fig.width=4, fig.align='center', echo=FALSE, fig.cap='GitHub Repository for sparklyr.'}
...
```{r estarting-spark-web-shot, echo=FALSE}
...
```
```{r starting-spark-render, fig.width=4, fig.align='center', echo=FALSE, fig.cap='Apache Spark Web Interface.'}
...
```
```{r starting-spark-web-storage-render, fig.width=4, fig.align='center', echo=FALSE, fig.cap='Apache Spark Web Interface - Storage Tab.'}
...
```{r  starting-rstudio-overview, fig.width=4, fig.align='center', echo=FALSE, fig.cap='RStudio Overview.'}
...
```{r starting-rstudio-new-connection, fig.width=4, fig.align='center', echo=FALSE, fig.cap='RStudio New Spark Connection.'}
...
```{r starting-rstudio-connections-pane, fig.width=4, fig.align='center', echo=FALSE, fig.cap='RStudio Connections Pane.'}
