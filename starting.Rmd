...
However, to make sure we can all run the code above and understand it, this chapter will walk you through installing the prerequisites, installing Spark, connecting to a local Spark cluster and briefly explaining how to use Spark.
