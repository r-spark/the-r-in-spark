...
```
```{r tuning-graph-sql-render, eval=TRUE, echo=FALSE, fig.align = 'center', fig.cap='Spark graph visualization'}
...
```
```{r tuning-timeline-repartition, eval=TRUE, echo=FALSE, fig.align='center', out.width='90%', fig.cap='Spark Event Timeline with Additional Partitions'}
