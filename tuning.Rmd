...
When using YARN in Cluster mode, `sparklyr.shell.driver-cores` can be used to configure total cores requested in the driver node, the "Running Spark on YARN" guide provides additional configuration settings worth familiarizing with.
