...
Notice that the columns must be numeric so you will have to manually convert them with feature transformin techniques presented in the [Modeling](#modeling) chapter. It is natural to try to add more layers to classify more complex datasets; however, adding too many layers will cause the gradient to vanish and other techniques will have to use these deep layered networds also known as, deep learning models.
