...
[rsparkling](https://github.com/h2oai/sparkling-water/tree/master/r) provies [H2O](https://www.h2o.ai/) support in Spark using `sparklyr`:
...
cars_tbl <- copy_to(sc, mtcars, "mtcars")
