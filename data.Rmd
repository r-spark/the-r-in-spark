...
```{r data-copy-create}
dir.create("large-file.txt")
write.table(matrix(rnorm(10 * 10^6), ncol = 10), "large-file.txt/1",
            append = T, col.names = F, row.names = F)
for (i in 2:30) 
  file.copy("large-file.txt/1", paste("large-file.txt/", i))
```
...
```{r data-copy-unlink}
unlink("large-file.txt", recursive = TRUE)
