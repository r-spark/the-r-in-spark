...
```{r}
conf <- spark_config()
conf$sparklyr.defaultPackages <- "com.google.cloud:google-cloud-storage:1.72.0"
sc <- spark_connect(master = "local", config = conf)
my_file <- spark_read_csv(
  sc, 
  "my-file", 
  path = "gs://gcp-public-data-sentinel-2/index.csv.gz-BQU6JALH41	"
  )
