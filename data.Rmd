...
write.csv(x, "data/test.csv", row.names = FALSE)
rx <- readr::read_csv("data/test.csv", n_max = 10)
readr::spec(rx)

top_rows <- read.csv("data/test.csv", nrows = 5)
...
For example, let's create the following `test.csv` file with as follows:
...
```{r}
col_spec_1 <- c(x = "character", y = "numeric")
col_spec_1
```
```
##           x           y 
...
test_1 <- spark_read_csv(sc, "test1","data/test.csv", 
                         columns = col_spec_1)
test_1
```
...
```{r}
col_spec_2 <- c(my_letter = "character", my_number = "character")

test_2 <- spark_read_csv(sc, "test2","data/test.csv", 
                         columns = col_spec_2)
test_2
```
...
```{r}
mapped_test <- spark_read_csv(sc, "test","data/test.csv", memory = FALSE)
```
