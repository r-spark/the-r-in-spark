...
The main goal is to write the data transformations using R syntax as much as possible. To accomplish this, instead of writing Spark SQL statements for data exploration, it is better to take advantage of `sparklyr`'s `dplyr` back-end interface.  
