...
The `sparklyr` package implements data analysis principles of R and specifically a subset of R packages called the `tidyverse`.  If you are new to R, Data Science, or the `tidyverse`, it is recommended to read the book *R for Data Science* [@intro-r-for-data-science]. This chapter will try to briefly introduce all the concepts it presents.
...
```{r, eval = TRUE, out.width='800pt', out.height='400pt', fig.align = 'center', fig.cap = 'Using rplot() to visualize correlations', echo = FALSE}
...
```{r echo=FALSE, fig.cap='Analysis vs Production projects', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 2
#padding: 10
...
```{r echo=FALSE, out.width='100%', out.height='220pt', fig.cap='R Markdown output formats', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#padding: 10
