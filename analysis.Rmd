...
```{r echo=FALSE, fig.cap='General steps of a data analysis', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r echo=FALSE, fig.cap='Spark capabilities', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: down
#fontSize: 18
#padding: 30
...
```{r echo=FALSE, fig.cap='R as an interface for Spark', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#padding: 40
#spacing: 140
...
```{r echo=FALSE, fig.cap='dplyr-to-SQL translation', fig.align = 'center', eval = TRUE}
render_nomnoml("
[R code |
	[filter(y == 1) |
    	[Wraps Spark SQL |
...
```{r echo=FALSE, fig.cap='Import Data to Spark not R', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#padding: 40
#spacing: 140
...
render_image("images/analysis-wrangling-1.png", "A Caption")
```
...
```{r echo=FALSE, fig.cap='Stages of a plot', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r, eval = TRUE, fig.cap='Plotting inside R', fig.align = 'center', eval = TRUE}
...
```{r echo=FALSE, fig.cap='R plotting function', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r echo=FALSE, fig.cap='Plotting with Spark and R', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r, eval = TRUE, fig.align = 'center', echo = FALSE}
render_image("images/analysis-visualizations-1.png", "A Caption")
```
...
```{r, eval = TRUE, fig.align = 'center', echo = FALSE}
render_image("images/analysis-visualizations-2.png", "A Caption")
```
...
```{r echo=FALSE, fig.cap='Typical Data Science Project', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r echo=FALSE, fig.cap='Working with Big Data', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#spacing: 100
#arrowSize: 0.3
...
```{r echo=FALSE, fig.cap='Works for embarassing parallel jobs', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: down
#padding: 20
#fontSize: 18
...
```{r echo=FALSE, fig.cap='Running a single large job', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: down
#padding: 20
#fontSize: 18
