...
labs(title = "Cars by Miles Per Galon",
...
This chapteer presented a solif introduction to data analyhsis with R and Spark; many of the techniques presented looked quite similar to using just R and no Spark; which while anticlimactic, it's the right design to help users already familiar with R to easily transition to Spark. For users unfamiliar with R, this chapter also served as a very brief introduction to some of the most popular (and useful!) packages available in R.
