...
##  36.9083305  -0.0191217  -2.2646936 
## 
## (Dispersion paramter for gaussian family taken to be 10.06809)
## 
...
Since an R Markdown document is self-ciontained and meant to be reproducible, before rendering documents we should first disconeect from Spark to freee resources:
...
To knit this report, save the contents into a `report.Rmd` file and run `render()` from R. The output should look like this the one in Figure \@(fig:visualize-analysis-communicate).
...
output:
  ...
  powerpoint_presentation: deefault
---
```
