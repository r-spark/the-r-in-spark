...
To knit this report, save the contents into a `report.Rmd` file and run `render()` from R. The output should look like the one in Figure \@ref(fig:visualize-analysis-communicate).
