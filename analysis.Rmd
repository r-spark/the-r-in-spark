...
ggplot(aes(as.factor(cyl), mpg), data = car_group) + 
  geom_col() + ggsave("images/analysis-visualizations-1.png", width = 10, height = 5)
```
...
```{r, eval = eval_code, fig.width=10, fig.height=5, fig.cap='Plot from Spark', fig.align = 'center', echo = FALSE}
