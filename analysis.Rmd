...
A very common exploration technique is to calculate and visualize correlations. We often calculate correlations to find out what kind of statistical relationship are between paired sets of variables. Spark provides functions that calculate correlations across the entire data set.  The results are then returned to R as a `data.frame` object. 
...
Additionally, the results can be easily visualized using the `rplot()` function; Figure \@ref(fig:analysis-corrr-rplot) is an example the plot resulting of combining these two functions. 
...
```{r analysis-plot, echo=FALSE, out.width='100%', out.height='100pt', fig.cap='Stages of a plot', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r analysis-mtcars-plot, echo=FALSE, out.width='100%', out.height='200pt', fig.cap='R plotting function', fig.align = 'center', eval = TRUE}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r analysis-viz1, eval = TRUE, fig.width=10, fig.height=5, fig.cap='Plot from Spark', fig.align = 'center', echo = FALSE}
...
```{r analysis-viz3, eval = TRUE, fig.width=10, fig.height=5, fig.cap='Histogram created by dbplot', fig.align = 'center', echo = FALSE}
...
```{r analysis-viz4, eval = TRUE, fig.width=10, fig.height=5, fig.cap='Refined Histogram', fig.align = 'center', echo = FALSE}
...
```{r analysis-point, eval = TRUE, fig.width=10, fig.height=5, fig.cap='Scatter plot example', fig.align = 'center', echo = FALSE}
...
```{r analysis-raster1, eval = TRUE, fig.width=10, fig.height=5, fig.cap='Using dbplot_raster()', fig.align = 'center', echo = FALSE}
...
```{r, eval = TRUE, fig.width=10, fig.height=5, fig.cap='R Markdown HTML output', fig.align = 'center', echo = FALSE}
