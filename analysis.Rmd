...
```{r echo=FALSE, out.width='100%', out.height='100pt', fig.cap='Stages of a plot', fig.align = 'center', eval = eval_code}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r echo=FALSE, out.width='100%', out.height='200pt', fig.cap='R plotting function', fig.align = 'center', eval = eval_code}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
```{r echo=FALSE, out.width='100%', out.height='200pt', fig.cap='Plotting with Spark and R', fig.align = 'center', eval = eval_code}
render_nomnoml("
#direction: right
#edgeMargin: 4
#padding: 25
...
The `dbplot` package provides helper function for plotting with remote data.  The package uses `dplyr` to push the calculations to Spark and collects the results.
