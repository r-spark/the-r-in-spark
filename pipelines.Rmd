...
```{r echo=FALSE}
# manually registered since rmakrdown won't restart the session
sparklyr::register_extension("mleap")
```
...
[^4]: Note that, as of the writing of this book, MLeap does not yet support Spark 2.4.
...
ml_write_bundle(spark_model, sample_input_tbl, "mleap_model.zip")
```
