...
writeLines(c(profiles[1], sample(profiles, 10^5)), "data/profiles.csv")
```
...
betas %>%
  ...
  ggplot(aes(term, beta, fill = factor(topic))) +
    ...
    coord_flip()
```
```{r modeling-unsuper-lda-betas-save, echo=FALSE}
lda_model <-  ml_lda(
  essays, ~ words, 
...
```
```{r modeling-unsuper-lda-betas-plot, echo=FALSE}
