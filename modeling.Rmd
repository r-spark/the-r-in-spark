...
Finally, to conclude this chapter you should disconnect from Spark. [Chapter 5](#pipelines) also makes use of the `OKCupid` dataset, but we provide instructions to reload it from scratch:
