...
We will use the training dartaset in the Pipelines chapter, so lets save thi to disk; we will save as Parquet, which is an efficient format ideal for numeric data:

```{r}
spark_write_parquet(okc_train, "okc-train.parquet")
```
