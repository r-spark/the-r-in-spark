...
```{r intro-spark-unified, echo=FALSE, out.width='100%', out.height='220pt', fig.cap='Spark as a unified analytics engine for large-scale data processing', fig.align = 'center'}
render_nomnoml("
#direction: down
#fontSize: 16
#padding: 16
