...
Mathematician George Stibitz used the word **digital** to describe fast electric pulses back in 1942 [@computing-concise-history]. To this day, we describe information stored electronically as digital information, stored and processed in electronic computers. In contrast, **analog** information is defined as, not digital [@webster2006merriam] and it represents everything we have stored by any non-electronic means such as: hand written notes, books, newspapers and so on.
