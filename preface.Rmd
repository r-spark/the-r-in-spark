...
To the package authors that released extensions to enrich the Spark and R ecosystem we thank **crassy** by Akhil Nair, **geospark** by Harry Zhu, **graphframes** by Kevin Kuo, **mleap** by Kevin Kuo, **rsparkling** by Jakub Hava and Navdeep Gill, **spark.sas7bdat** by Jan Wijffels, **sparkavro** by Aki Ariga, **sparkbq** by Martin Studer, **sparklyr.nested** by Matt Pollock, **sparktf** by Kevin Kuo, **sparkts** by Nathan Eastwood, **sparkwarc** by Javier Luraschi, **sparkxgb** by Kevin Kuo and **variantspark** by Samuel Macêdo.
