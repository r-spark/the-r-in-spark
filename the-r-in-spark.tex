...
\begin{verbatim}
## 18/05/18 17:23:56 INFO SparkContext: Submitted application: sparklyr
## 18/05/18 17:23:56 INFO SparkContext: Added JAR file:/Library/Frameworks/R.framework/Versions/3.5/Resources/library/sparklyr/java/sparklyr-2.3-2.11.jar at spark://localhost:60613/jars/sparklyr-2.3-2.11.jar with timestamp 1526689436853
## 18/05/18 17:24:00 INFO Executor: Fetching spark://localhost:60613/jars/sparklyr-2.3-2.11.jar with timestamp 1526689436853
## 18/05/18 17:24:00 INFO Utils: Fetching spark://localhost:60613/jars/sparklyr-2.3-2.11.jar to /private/var/folders/fz/v6wfsg2x1fb1rw4f6r0x4jwm0000gn/T/spark-34be0b63-9a14-4854-9e48-f700c5a4bd0a/userFiles-017d38bf-ee71-4fee-8f6d-453bc793c880/fetchFileTemp2304545655271925897.tmp
## 18/05/18 17:24:00 INFO Executor: Adding file:/private/var/folders/fz/v6wfsg2x1fb1rw4f6r0x4jwm0000gn/T/spark-34be0b63-9a14-4854-9e48-f700c5a4bd0a/userFiles-017d38bf-ee71-4fee-8f6d-453bc793c880/sparklyr-2.3-2.11.jar to class loader
\end{verbatim}
...
consider skipping to the next chapter, Connections, which will teach you
how to connect to an existing clusters.

If don't have a cluster or are considering improvements to your existing
infrastructure, this chapter will introduce the most common cluster
...
\textbf{mainframes}, \textbf{cloud computing} and \textbf{kubernetes}.
Framing these trends over time will help us understand what they are and
how they came to be:

\begin{figure}
\centering
\includegraphics{the-r-in-spark_files/figure-latex/unnamed-chunk-17-1.pdf}
\caption{\label{fig:unnamed-chunk-17}Google trends for mainframe, cloud
computing and kubernetes.}
\end{figure}

\emph{On-premise} stands for on-premise, meaning that someone, either
...
command line to request and manage resources.

\hypertarget{on-premise-vs-cloud-vs-kubernetes}{%
\section{On-Premise vs Cloud vs
Kubernetes}\label{on-premise-vs-cloud-vs-kubernetes}}
...
former, on-premise cluster or on-premise for short and, cloud clusters
or on-demand cluster for the latter one. Each have different tradeoffs
worth considering.
...
it's an \textbf{on-premise} vs \textbf{cloud} cluster, the
...
\subsection{On-Premise}\label{on-premise}}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(month }\OperatorTok{<}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\StringTok{"2018-01-01"}\NormalTok{)) }\OperatorTok{%>%}
