...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{predictions <-}\StringTok{ }\KeywordTok{copy_to}\NormalTok{(sc, fueleconomy}\OperatorTok{::}\NormalTok{vehicles) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ml_gaussian_mixture}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{hwy }\OperatorTok{+}\StringTok{ }\NormalTok{cty, }\DataTypeTok{k =} \DecValTok{3}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ml_predict}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{collect}\NormalTok{()}

\NormalTok{predictions }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(hwy, cty)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(hwy, cty, }\DataTypeTok{col =} \KeywordTok{factor}\NormalTok{(prediction)), }\DataTypeTok{size =} \DecValTok{2}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.4}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_color_discrete}\NormalTok{(}\DataTypeTok{name =} \StringTok{""}\NormalTok{, }\DataTypeTok{labels =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Cluster"}\NormalTok{, }\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Highway"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"City"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_light}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\includegraphics{the-r-in-spark_files/figure-latex/unnamed-chunk-24-1.pdf}
\caption{\label{fig:unnamed-chunk-24}Fuel economy data for 1984-2015 from
the US EPA}
\end{figure}
...
You can turn your \texttt{sparklyr} models into data frames using the
\texttt{broom} package:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model <-}\StringTok{ }\NormalTok{cars_tbl }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ml_linear_regression}\NormalTok{(mpg }\OperatorTok{~}\StringTok{ }\NormalTok{wt }\OperatorTok{+}\StringTok{ }\NormalTok{cyl)}

\CommentTok{# Turn a model object into a data frame}
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-33-1} 
...
{\centering \includegraphics[width=1\linewidth,height=220pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-41-1} 
...
{\centering \includegraphics[width=1\linewidth,height=140pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-42-1} 
...
{\centering \includegraphics[width=1\linewidth,height=160pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-44-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-47-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-49-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-51-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-53-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-55-1} 
...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-57-1} 
...
\caption{Spark Graph Visualization}\label{fig:unnamed-chunk-81}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{gf_graphframe}\NormalTok{(vertices_tbl, edges_tbl) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{gf_pagerank}\NormalTok{(}\DataTypeTok{reset_prob =} \FloatTok{0.15}\NormalTok{, }\DataTypeTok{max_iter =}\NormalTok{ 10L)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{the-r-in-spark_files/figure-latex/unnamed-chunk-91-1} 

}

\caption{Highschool ggraph dataset with pagerank highlighted.}\label{fig:unnamed-chunk-91}
\end{figure}
...
\href{https://github.com/rstudio/mleap}{Mleap} enables Spark pipelines
in production.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Create pipeline}
\NormalTok{pipeline_model <-}\StringTok{ }\KeywordTok{ml_pipeline}\NormalTok{(sc) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ft_binarizer}\NormalTok{(}\StringTok{"hp"}\NormalTok{, }\StringTok{"big_hp"}\NormalTok{, }\DataTypeTok{threshold =} \DecValTok{100}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ft_vector_assembler}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"big_hp"}\NormalTok{, }\StringTok{"wt"}\NormalTok{, }\StringTok{"qsec"}\NormalTok{), }\StringTok{"features"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ml_gbt_regressor}\NormalTok{(}\DataTypeTok{label_col =} \StringTok{"mpg"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ml_fit}\NormalTok{(cars_tbl)}

\CommentTok{# Perform predictions}
\NormalTok{predictions_tbl <-}\StringTok{ }\KeywordTok{ml_predict}\NormalTok{(pipeline_model, mtcars_tbl)}

\CommentTok{# Export model with mleap}
\KeywordTok{ml_write_bundle}\NormalTok{(pipeline_model, predictions_tbl, }\StringTok{"mtcars_model.zip"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Use model outside Spark and productions systems. For instance, in
{Java:}
...
{\centering \includegraphics[width=1\linewidth,height=280pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-98-1} 
...
{\centering \includegraphics[width=1\linewidth,height=280pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-102-1} 
