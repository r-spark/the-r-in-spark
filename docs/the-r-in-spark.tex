...
{\centering \includegraphics[width=1\linewidth]{the-r-in-spark_files/figure-latex/unnamed-chunk-18-1} 
...
\caption{Spark Graph Visualization}\label{fig:unnamed-chunk-66}
\end{figure}
...
\caption{Spark Event Timeline}\label{fig:unnamed-chunk-70}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth,height=280pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-75-1} 
...
{\centering \includegraphics[width=1\linewidth,height=280pt]{the-r-in-spark_files/figure-latex/unnamed-chunk-79-1} 
...
\StringTok{  }\KeywordTok{spark_apply}\NormalTok{(}\ControlFlowTok{function}\NormalTok{(df) \{}
    \KeywordTok{data.frame}\NormalTok{(}
      \DataTypeTok{rows =} \KeywordTok{jitter}\NormalTok{(}
        \KeywordTok{as.numeric}\NormalTok{(}
          \KeywordTok{gsub}\NormalTok{(}\StringTok{"Row "}\NormalTok{, }\StringTok{""}\NormalTok{, df}\OperatorTok{$}\NormalTok{text)}
\NormalTok{        )}
\NormalTok{      )}
\NormalTok{    )}
\NormalTok{  \})}
