...
class FileReader:
def read = {}]]
', "images/contributing-types-of-extensions.ong")
```
...
First, in order to compile Scala code, you will need a Scala compiler for Scala 2.11 and 2.12 from [https://www.scala-lang.org/](https://www.scala-lang.org); these compilers can be automatically downloaded and installed using `download_scalac`:
