...
```{r contributing-sparklyr, eval=TRUE,echo=FALSE, out.width='100%', out.height='220pt', fig.cap='Sparklyr Package Architecture', fig.align = 'center'}
nomnoml::nomnoml("
#spacing: 15
[sparklyr|
  [R Code]
...
```{r contributing-connection, eval=TRUE, echo=FALSE, out.width='100%', out.height='220pt', fig.cap='Sparklyr Connection Architecture', fig.align = 'center'}
nomnoml::nomnoml("
#spacing: 15
[R|
  [sparklyr|
