...
set.seed(100)
writeLines(
  LETTERS[sample(length(LETTERS), size = 1000, replace = TRUE)],
  "/home/edgar/kafka_2.12-2.2.0/output.txt"
  )
system2("/home/edgar/kafka_2.12-2.2.0/bin/kafka-console-producer.sh", c("--broker-list localhost:9092", "--topic letters", "< /home/edgar/kafka_2.12-2.2.0/output.txt"))  
```
