...
In the next chapter, [Data](#data), we will cover how to user Spark to read and write from a variety of data sources and formats which allows you to me more agile when adding new data sources for data analysis -- what used to take days, weeks or even months now can be done without overhead by embracing new storage architectures and practices known today as data lakes.
