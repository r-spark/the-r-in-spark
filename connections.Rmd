...
Scaling analysis, modeling and data lakes, usually requires us you to tweak configuration parameters in Spark to make efficient use of your cluster resources or unblock functionality. For instance, you might need to request additional memory to load an entire data lake -- requesting additional resources and identifying bottlenecks will be the topic of the chapter, Tuning.
