...
```{r echo=FALSE}
Sys.setenv(PATH_TO_SPARKLYR_JAR = dir(system.file("java", package = "sparklyr"), pattern = gsub("\\.0", "", paste("sparklyr", sparklyr::spark_default_version()$spark, sep = "-")), full.names = T))
```
