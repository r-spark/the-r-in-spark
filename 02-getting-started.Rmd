...
```{r r-download, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='The R Project for Statistical Computing.'}
if (nchar(Sys.which("phantomjs")[[1]]) == 0) webshot::install_phantomjs()

webshot::webshot(
  "https://r-project.org/", cliprect = "viewport"
)
```

### Install Java 8

From [oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html), download and launch the installer for your platform, Windows, Macs or Linux available.

```{r java-download, fig.width = 4, fig.align = 'center', echo=FALSE, fig.cap='Java Downloads.'}
webshot::webshot(
