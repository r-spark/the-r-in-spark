...
"
```
```{r distributed-times-ten, echo=FALSE, eval=TRUE, fig.cap='Map Operation when Multiplying by Ten', fig.align='center', out.height = '280pt', out.width = 'auto'}
render_nomnoml("
[Data |
  [1]
  [2]
...
```{r distributed-r-using-arrow, eval=TRUE, echo=FALSE, fig.cap='Data Transformation between Spark and R using Arrow', out.height = '260pt', out.width = 'auto', fig.align = 'center'}
render_nomnoml("
#direction: right
#.left: align=left
