...
For complex computations with multiple dependent functions:
...
You can add the functions your clousure needs into the `context` followed by assigning the functions into the global environment as follows:
...
When this is not feasible, you can also create your own R package which the functionality you need and then use your package from `spark_apply()`.
