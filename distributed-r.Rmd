...
#direction: right
#.left: align=left
[Spark|[a,1,10|b,2,20|c,3,30] -> [Arrow]
[Arrow] -> [<left>a,b,c|1,2,3|10,20,30]
[a,b,c] -> [Arrow]
[Arrow] -> [a,1,10]
] -> [R]
[R|[<left>a,b,c|1,2,3|10,20,30]] -> [Spark]", "images/distributed-r-data-using-arrow.png")
```

Arrow is not required but it is strongly advised while working `spark_apply()`. It has been available since Spark 2.3.0 and requires system administrators to install the Apache Arrow runtime in every node.
